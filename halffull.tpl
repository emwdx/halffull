...
<body>
   ...
   <div class = "span8 offset2">
    ...
    <div class = "container">
    <div class = "row-fluid" >
    <p class = "text-center"><a href = "/halffull/2/"><button type = "submit" id = "submitButton" class = "btn btn-primary" style = "color:#FFFFFF; background:#004DBF"><h1>Submit</h1></button></a></p>
    </div>
    </div>
...
var bkRectangle = paper.rect(0,10,800,200).attr({fill:"#B5C1E8", stroke:0});
var colorRectangle = paper.rect(0,10,100,200).attr({fill:"#004DBF",stroke:0});
$(function() {
		$( "#colorSlider").slider({
