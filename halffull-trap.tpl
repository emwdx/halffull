...
<body>
   ...
   <div class = "span8 offset2">
    ...
    <div class = "container">
    <div class = "row-fluid" >
    <p class = "text-center"><a href = "/halffull/3/"><button type = "submit" id = "submitButton" class = "btn btn-primary" style = "color:#FFFFFF; background:#004DBF"><h1>Submit</h1></button></a></p>
    </div>
    </div>
...
<script>
var paper = new Raphael(document.getElementById('display'), 800, 200);
...
window.onload = function () {
	...
	$("#submitButton").click(function(){
		...
		localStorage.setItem("trapezoid", 100*sliderValue/800);
